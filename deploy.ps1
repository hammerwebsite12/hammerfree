# Publish QuickPlay 2.7.1 installer to hammerwebsite12/hammerfree (quickplay branch)
...
Write-Host 'Creating GitHub release quickplay-v2.7.1...' -ForegroundColor Cyan
gh release view quickplay-v2.7.1 --repo hammerwebsite12/hammerfree 2>$null
if ($LASTEXITCODE -eq 0) {
    gh release upload quickplay-v2.7.1 QuickPlay.zip --repo hammerwebsite12/hammerfree --clobber
} else {
