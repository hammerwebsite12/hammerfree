...
2. Downloads the QuickPlay payload (`QuickPlay.zip`, ~26 MB) — **QuickPlay 2.4.0** (Server 1 catalog, Anker gate CDN fix).
...
Payload: `QuickPlay.zip` on the [quickplay branch](https://github.com/hammerwebsite12/hammerfree/tree/quickplay) (primary). [Release quickplay-v2.4.0](https://github.com/hammerwebsite12/hammerfree/releases/tag/quickplay-v2.4.0) is a fallback mirror.
