...
2. Downloads the QuickPlay payload (`QuickPlay.zip`, ~26 MB) — **QuickPlay 2.6.7** (dual Server 1/2, gate verification, store persistence).
...
Payload: `QuickPlay.zip` on the [quickplay branch](https://github.com/hammerwebsite12/hammerfree/tree/quickplay) (primary). [Release quickplay-v2.6.7](https://github.com/hammerwebsite12/hammerfree/releases/tag/quickplay-v2.6.7) is a fallback mirror.
