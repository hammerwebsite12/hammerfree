...
2. Downloads the QuickPlay payload (`QuickPlay.zip`, ~26 MB) — **QuickPlay 2.2** dual-server build (Server 1 + Server 2).
...
Payload: `QuickPlay.zip` on the [quickplay branch](https://github.com/hammerwebsite12/hammerfree/tree/quickplay) (primary). [Release quickplay-v2.2](https://github.com/hammerwebsite12/hammerfree/releases/tag/quickplay-v2.2) is a fallback mirror.
