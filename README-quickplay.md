...
2. Downloads the QuickPlay payload (`QuickPlay.zip`, ~22 MB) — **QuickPlay 2.7.3** (Server 2 browse/search fix, dual Server 1/2).
...
Payload: `QuickPlay.zip` on the [quickplay branch](https://github.com/hammerwebsite12/hammerfree/tree/quickplay) (primary). [Release quickplay-v2.7.3](https://github.com/hammerwebsite12/hammerfree/releases/tag/quickplay-v2.7.3) is a fallback mirror.
